...
open class FGApplication: FGObjectSerializable, CustomStringConvertible {
    ...
    /// The infrastructure can be virtual, generated by an application and in this case 
    /// the applications parameter is needed and it has to contain a list of application ids 
    /// able to generate the infrastructure.
